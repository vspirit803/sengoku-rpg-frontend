      ...
      <v-img max-height="100%" :src="imageUrl" lazy-src="assets/images/C9999.png">
        ...
        <v-expand-transition>
          <div v-if="hover" class="property-panel transition-fast-in-fast-out grey white--text">
            ...
            <div v-for="eachProperty in Object.keys(character.properties)" :key="eachProperty" class="property">
              ...
              <span style="display: inline-block;" v-if="character.properties[eachProperty].increaseValue !== 0">
